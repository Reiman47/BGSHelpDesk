export const translations: any = {
  en: {
    ...
    addressValue: "Office No: 406, 4th Floor, Akaria Building 3, Olaya Street, Riyadh, KSA.",
  ...
  ar: {
    ...
    addressValue: "مكتب رقم 406، الطابق الرابع، مبنى العقارية 3، شارع العليا، الرياض، المملكة العربية السعودية",
    phoneValue: "+966 11 213 1355",
